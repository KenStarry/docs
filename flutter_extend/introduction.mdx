...
<CardGroup cols={2}>
  <Card
    ...
    href="/flutter_extend/api/context/navigator"
  >
  ...
  <Card
    ...
    href="/flutter_extend/api/widget/scaffold"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/flutter_extend/api/string/currency"
  >
  ...
  <Card
    title="Theme Access"
    icon="palette"
    href="/flutter_extend/api/context/theme"
  >
...
<Card
  ...
  icon="rocket"
  href="/flutter_extend/installation"
  horizontal
>
