...
This extension's primary purpose is to leverage the string itself as a seed for external asset generators (like DiceBear), ensuring that the same input string always produces the same unique output avatar.
